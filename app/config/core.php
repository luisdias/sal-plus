 ...
 */
	Configure::write('Security.salt', '4940e9652eed2b0032eb0edc3f878b9fd1bce173');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '376464623964663461396538306537');
 ...
 */
	Cache::config('default', array('engine' => 'File'));
        Configure::write('Config.language', 'bra');
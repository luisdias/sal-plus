...
<div class="table">
    ...
    <h4><i class="fa fa-angle-right"></i> Tipos de evento</h4>
    <section id="unseen">     
            ...
            <td class="actions">
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><?php echo $this->Html->link("Consultar", array('action' => 'view', $tipoevento['Tipoevento']['id']),array('escape' => false)); ?></li>
                    <li><?php echo $this->Html->link("Editar", array('action' => 'edit', $tipoevento['Tipoevento']['id']),array('escape' => false)); ?></li>
                    <li><?php echo $this->Html->link("Excluir", array('action' => 'delete', $tipoevento['Tipoevento']['id']),array('escape' => false), sprintf(__('Tem certeza que deseja excluir o tipo de evento %s?', true),$tipoevento['Tipoevento']['title'])); ?></li>
                  </ul>
                </div>                
            </td>
	</tr>        

<div class="row mt">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Modalidade',array('class'=>'form-horizontal style-form'));?>
	<fieldset>
		<legend><?php 
                if ( $this->action == 'add' )
                    $theAction = 'Nova';
	...
	<?php
		...
		echo $this->Form->input('title',array('label'=>false,'div'=>'col-sm-10','class'=>'form-control'));
                echo "</div>";                

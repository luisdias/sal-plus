...
<div class="table">
	...
	<tr>
		...
		<td><?php echo $contratante['Contratante']['categoria']; ?>&nbsp;</td>
                <td class="actions">
                <?php echo $this->Html->link($this->Html->image("page-find.gif", array("alt" => "Consultar","title" => "Consultar")), array('action' => 'view', $contratante['Contratante']['id']),array('escape' => false)); ?>
                <?php echo $this->Html->link($this->Html->image("edit-icon.gif", array("alt" => "Editar","title" => "Editar")), array('action' => 'edit', $contratante['Contratante']['id']),array('escape' => false)); ?>
                <?php echo $this->Html->link($this->Html->image("hr.gif", array("alt" => "Excluir","title" => "Excluir")), array('action' => 'delete', $contratante['Contratante']['id']),array('escape' => false), sprintf(__('Tem certeza que deseja excluir o contratante %s?', true), $contratante['Contratante']['name'])); ?>
                </td>
	</tr>        
        <?php endforeach; ?>
    </table>

<div class="row mt">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Tipoaditivo',array('class'=>'form-horizontal style-form'));?>
                <fieldset>
                        <legend>
                        <?php 
                        if ( $this->action == 'add' )
		...
		echo $this->Form->input('title',array('label'=>false,'div'=>'col-sm-10','class'=>'form-control','size'=>'25'));
                echo "</div>";
